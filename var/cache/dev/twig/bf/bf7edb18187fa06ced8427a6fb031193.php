...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "/home/langlet/docker/docker_symfony/terque/vendor/symfony/web-profiler-bundle/Resources/views/Collector/mailer.html.twig");
    }
}
